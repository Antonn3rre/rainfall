...
int (*dword_8049900)(void) = NULL; // weak
...
int sub_80483A0()
{
  return dword_8049900();
}
// 8049900: using guessed type int (*dword_8049900)(void);
...
// 8048443: positive sp value 4 has been found
...
// 8049820: using guessed type int _DTOR_LIST__[];
// 8049824: using guessed type int _DTOR_END__;
// 8049930: using guessed type char completed_6159;
// 8049934: using guessed type int dtor_idx_6161;
...
// 8049828: using guessed type int _JCR_LIST__;
...
void __cdecl _libc_csu_init(int a1, int a2, int a3)
{
  ...
  init_proc();
  v3 = (134519032 - (int)&GLOBAL_OFFSET_TABLE_) >> 2;
  if ( v3 )
  {
    for ( i = 0; i != v3; ++i )
...
// 8049818: using guessed type int _CTOR_LIST__[];
// 80498F8: using guessed type Elf32_Dyn *GLOBAL_OFFSET_TABLE_;
...
// nfuncs=29 queued=9 decompiled=9 lumina nreq=0 worse=0 better=0
